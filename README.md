...
Primeramente comenzamos con la creacion de un repositorio publico en GIT, exclusivo para este trabajo https://github.com/maikool22/obligatorio-boutique. Una vez los integrandes del equipo clonan el repo, lo sincronizamos con Visual Studio Code y comenzamos a trabajar:
